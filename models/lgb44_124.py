...
feas = feas.drop(['trade_cnt','hour','weekday','hour_v','device_cnt2','device_cnt1','ip_cnt1','ip_cnt2'
                     ,'trade_weekday_cnt','trade_weekday_cnt_rate','hour_v_cnt','hour_v_cnt_rate','is_risk'],axis=1)
#
# print feas.shape
...
droplist = ['trade_cnt','trade_weekday_cnt','trade_weekday_cnt_rate','hour_v_cnt',
...
params = {
    ...
    #'learning_rate': 0.05,
    'feature_fraction': 0.20667149999999998,    # 随机选 90% 的特征用于训练
